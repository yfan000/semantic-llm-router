...
\begin{table}[t]
  ...
  \begin{tabular}{llrrrrr}
    \toprule
    & & \multicolumn{5}{c}{Accuracy\,/\,Cost per request (\$)} \\
    \cmidrule(lr){3-7}
    Domain & Cmplx & RR & Cascade & RouteLLM & T-Opt-Acc & \sysname \\
    \midrule
    \multirow{3}{*}{Factual}
      & Easy   & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} \\
      & Medium & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} \\
      & Hard   & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} \\
    \midrule
    \multirow{3}{*}{Math}
      & Easy   & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} \\
      & Medium & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} \\
    ...
    \multicolumn{2}{l}{\textbf{Overall}}
      & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \todo{X\,/\,\$X} & \result{97.1\%\,/\,\$\todo{X}} \\
    \bottomrule
  \end{tabular}
\end{table}
